...
import NewsletterSubscribe from '@/features/content/components/NewsletterSubscribe';
import { Facebook, Instagram, Twitter, Mail, Phone, ChevronRight } from 'lucide-react';
import { useFooter } from '@/features/content/hooks/useContentData';
  ...
  return (
    <footer className="relative bg-gradient-to-br from-[#FF9494] to-[#FFB4B4] text-white pt-16 pb-8">
      ...
      <div className="absolute top-0 left-0 right-0 h-4 bg-[#FF9494] shadow-lg">
        <div
          className="absolute top-0 left-0 right-0 h-2 bg-[#FFB4B4]"
          style={{
            clipPath:
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        >
          ...
          <p className="text-sm text-center md:text-left opacity-80">{footerData.description}</p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href={`tel:${footerData.phone}`} className="hover:text-white/80 transition-colors">
                {footerData.phone}
              </a>
            </div>
          </div>
