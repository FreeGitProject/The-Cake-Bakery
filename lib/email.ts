...
//     `,
//   };
export async function sendOrderConfirmationEmail(order: any, paymentMethod: string = 'Online Payment') {
    ...
    const message = {
      ...
      html: `
        ...
        <p><strong>Total: $${order.totalAmount.toFixed(2)}</strong></p>
        ${isCOD ? '<p>The total amount will be collected upon delivery.</p>' : ''}
