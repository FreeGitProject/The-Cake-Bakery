...
const deliveryPartners = ['Swiggy', 'Zomato', 'UberEats', 'Dunzo', 'In-house Delivery'];
      ...
      locations: [
        {
          ...
          coordinates: {
            ...
            mapUrl:
              'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1752.6056133790903!2d77.38762052489452!3d28.533370126037724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce8a68ffffff1%3A0xaf4867a2327d6c68!2sThe%20Cake%20Shop!5e0!3m2!1sen!2sin!4v1736051994561!5m2!1sen!2sin',
          },
          hours: {
            weekdays: {
              days: 'Monday - Friday',
              ...
              {form.watch('locations').map((location, locationIndex) => (
                <Accordion type="single" collapsible key={location.id} defaultValue="location">
                  <AccordionItem value="location">
                    <AccordionTrigger>
                      {form.watch(`locations.${locationIndex}.name`) ||
                                    ...
                                    <Checkbox
                                      ...
                                      onCheckedChange={(checked) => {
                                        return checked
                                          ...
                                          : field.onChange(
                                              field.value?.filter((value) => value !== partner)
                                            );
                                      }}
                                    />
                                  </FormControl>
