                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        placeholder={
                          newCoupon.discountType === 'percentage' ? 'e.g. 15' : 'e.g. 10'
                        }
                        className="pl-10"
                        required
                      />
                    ...
                    <CardContent className="pb-3">
                      <div className="space-y-4">
                        <div>
                          ...
                          {coupon.usageLimit && (
                            <Progress
                              value={getProgressValue(coupon.usageCount, coupon.usageLimit)}
                            />
                          )}
                        </div>
                        <p className="text-sm">
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              <strong>{coupon.code}</strong>? This action cannot be undone and may
                              affect customers who have this code.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
              ...
              {coupons.filter((coupon) => !isExpired(coupon.expiryDate)).length === 0 && (
                <Card className="col-span-full">
                  ...
                  <Button
                    variant="outline"
                    onClick={() =>
                      (document.querySelector('[data-value="create"]') as HTMLElement)?.click()
                    }
                  >
                    ...
                    <CardContent className="pb-3">
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-sm">
                            <span className="text-muted-foreground">Used:</span> {coupon.usageCount}{' '}
                            times
                          </p>
                          <p className="text-sm">
                            <span className="text-muted-foreground">Min order:</span> ₹
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Are you sure you want to delete the expired coupon{' '}
