  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => router.push('/admin/create-cake')}>Add New Cake</Button>
      </div>
      ...
      <Card className="mb-6">
        <CardContent className="pt-6">
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <Select value={cakeType} onValueChange={(value) => setCakeType(value)}>
            ...
            {isLoading ? (
              ...
              cakes.map((cake) => (
                <TableRow key={cake._id}>
                  ...
                  <TableCell>
                    <Link href={`/cakes/${cake._id}`} className="font-medium hover:underline">
                      {cake.name}
                    </Link>
                    <p className="text-sm text-gray-500">{cake.description.substring(0, 60)}...</p>
                  </TableCell>
                  ...
                  <TableCell>{cake.createdAt}</TableCell>
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() => router.push(`/admin/edit-cake/${cake._id}`)}
                        >
                          Edit
                        </DropdownMenuItem>
                        <DropdownMenuItem>
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Are you sure you want to delete this cake? This action cannot be
                                  undone.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction onClick={() => handleDelete(cake._id)}>
                                  Delete
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
