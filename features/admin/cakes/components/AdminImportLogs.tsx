              ...
              {importLogs.map((log) => (
                <React.Fragment key={log._id}>
                  <TableRow className="hover:bg-gray-50">
                    ...
                    <TableCell>
                      <Badge className={getStatusBadgeVariant(log.status)}>{log.status}</Badge>
                    </TableCell>
                    <TableCell className="text-right">{log.totalRecords}</TableCell>
                    <TableCell className="text-right text-green-600">{log.successCount}</TableCell>
                    <TableCell className="text-right text-red-600">{log.failureCount}</TableCell>
