      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Create and manage your website&apos;s home sections
          </p>
        </div>
        <Button
          onClick={() => {
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="grid w-full grid-cols-2">
          ...
          <TabsTrigger value="create">
            {currentData._id ? 'Edit Section' : 'Create Section'}
          </TabsTrigger>
        </TabsList>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Are you sure you want to delete this home section? This action cannot
                              be undone.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
        ...
        <TabsContent value="create">
          <Card>
            <CardHeader>
              <CardTitle>
                {currentData._id ? 'Edit Home Section' : 'Create New Home Section'}
              </CardTitle>
              <CardDescription>
                {currentData._id
                  ? 'Update the details for this home section'
                  : 'Fill in the details to create a new home section'}
              </CardDescription>
            </CardHeader>
            <CardContent>
