...
import { useCompanyInfo } from '@/features/content/hooks/useContentData';
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <motion.div className="lg:w-1/2" variants={itemVariants}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          {location?.hours.weekdays.days}: {location?.hours.weekdays.open} -{' '}
                          {location?.hours.weekdays.close}
                          <br />
                          {location?.hours.saturday.days}: {location?.hours.saturday.open} -{' '}
                          {location?.hours.saturday.close}
                          <br />
                          {location?.hours.sunday.days}: {location?.hours.sunday.open} -{' '}
                          {location?.hours.sunday.close}
                        </p>
                      </div>
                    </div>
                ...
                {activeTab === 'delivery' && (
                  <div className="space-y-6">
                    <div className="bg-[#FFF6F6] p-4 rounded-lg">
                      ...
                      <p className="text-gray-600">
                        Delivery Radius: {locationData?.delivery.radius}
                        <br />
            ...
            {/* Social Media Links */}
            <motion.div className="flex justify-center gap-4 mt-6" variants={itemVariants}>
              <motion.a
