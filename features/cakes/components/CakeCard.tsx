...
export default function CakeCard({
  ...
  const [selectedWeight, setSelectedWeight] = useState(cake.prices[0].weight.toString());
  ...
  const handleAddToCart = () => {
    const price = cake.prices.find((p) => p.weight.toString() === selectedWeight);
  ...
  return (
    ...
    >
      ...
      <CardContent className="relative pt-4">
        ...
        >
          <img src={cake.image[0]} alt={cake.name} className="w-full h-full object-cover" />
        </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Our cakes are baked fresh daily using premium ingredients. Each cake is
                  handcrafted by our expert pastry chefs.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Best served fresh. Can be refrigerated for up to 3 days. Do not freeze.
                </p>
              </div>
