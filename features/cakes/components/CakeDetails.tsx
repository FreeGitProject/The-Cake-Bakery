...
import AddonItemsModal from '@/features/cakes/components/AddonItemsModal';
      ...
      <div className="flex flex-col gap-4 p-4 lg:w-80">
        <div>
          ...
          <div className={`flex items-center mb-4 ${getTypeStyles(cake.type)}`}>
            ...
            <span className={`text-sm font-medium`}>{cake.type.toUpperCase()}</span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-bold">₹{selectedWeight.sellPrice}</span>
            ...
            {selectedWeight.costPrice != null && selectedWeight.costPrice > 0 && (
              <>
                ...
                <span className="text-green-600 text-sm">
                  {Math.round((1 - selectedWeight.sellPrice / selectedWeight.costPrice) * 100)}% OFF
                </span>
              </>
            )}
          </div>
        ...
        <div className="mt-2">
          ...
          {deliveryStatus && (
            ...
            >
              ...
              <AlertTitle>
                {deliveryStatus.deliverable ? 'Delivery Available' : 'Delivery Unavailable'}
              </AlertTitle>
