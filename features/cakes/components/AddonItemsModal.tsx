      ...
      <DialogContent className="sm:max-w-[600px] p-0 gap-0">
        <DialogHeader className="p-6 pb-2">
          <div className="flex items-center justify-between">
            <div>
              <DialogTitle className="text-2xl font-bold">Enhance Your Order</DialogTitle>
              <p className="text-gray-500 mt-1">
                Add these premium items to complete your experience
              </p>
            </div>
            {/* <Button
              variant="ghost"
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-1">
                        <Badge variant="secondary">₹{addon.price.toFixed(2)}</Badge>
        ...
        <div className="p-6 pt-2">
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="flex space-x-3">
              <Button variant="outline" onClick={handleSkip} className="w-24">
                Skip
              </Button>
