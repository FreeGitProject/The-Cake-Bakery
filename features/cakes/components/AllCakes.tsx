      ...
      <div className="container mx-auto px-3 sm:px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-sm sm:text-base px-2">
            ...
            {caketype === 'cake' ? 'cakes' : 'pastries'}, made with premium ingredients and passion
            for the perfect dessert experience.
          </p>
        </motion.div>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <Grid3X3
                                size={16}
                                className={viewMode === 'grid' ? 'text-[#FF9494]' : ''}
                              />
                            </Button>
                          </TooltipTrigger>
                          <TooltipContent>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <List
                                size={16}
                                className={viewMode === 'list' ? 'text-[#FF9494]' : ''}
                              />
                            </Button>
                          </TooltipTrigger>
                          <TooltipContent>
            ...
            <div className="mt-6">
              <div className="flex justify-between items-center mb-4">
                <p className="text-sm text-gray-500">
                  Showing {cakes.length} of {totalPages * itemsPerPage} results
                </p>
                {searchTerm && (
                  ...
                  {!isMobile &&
                    getVisiblePageNumbers().map((page, index) =>
                      typeof page === 'number' ? (
                        ...
                        <Button key={index} variant="ghost" disabled className="h-10 w-10 p-0">
                          {page}
                        </Button>
                      )
                    )}
