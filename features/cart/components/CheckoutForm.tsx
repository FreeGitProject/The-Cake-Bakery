...
import AddonItemsByCategory from '@/features/cakes/components/AddonItemsByCategory';
...
export default function PremiumCheckout() {
  const { cart, getCartTotal, clearCart, updateQuantity, updateCakeMessage, removeFromCart } =
    useCart();
  ...
  const renderCartItems = () => (
    <div>
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-6 space-y-4">
            <div className="flex items-center">
              ...
              />
              <Button type="button" onClick={handleApplyCoupon} disabled={!couponCode || isLoading}>
                Apply
              </Button>
            </div>
            ...
            {orderSummary.subtotal < 1000 && (
              <Alert>
                ...
                <AlertDescription>
                  Add items worth ₹{(1000 - orderSummary.subtotal).toFixed(2)} more for free
                  delivery!
                </AlertDescription>
              </Alert>
            )}
        ...
        <CardFooter>
          <Button className="w-full" onClick={handleNextStep} disabled={cart.length === 0}>
      ...
      {cart.length === 0 ? (
        <Card className="text-center py-8">
          <CardContent className="space-y-4">
            ...
            <Button onClick={() => router.push('/cakes')}>Continue Shopping</Button>
          </CardContent>
        </Card>
      ) : (
          ...
          {checkoutStep === 3 && (
            <Card>
              ...
              <CardFooter className="flex justify-between">
                <Button type="button" variant="outline" onClick={() => setCheckoutStep(2)}>
                  Back
                </Button>
